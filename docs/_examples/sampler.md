...
There is no markdown shortcut, but the following icons are provided in the ghpages template ([svg.html][svg-file]) and can be included via regular html syntax.
